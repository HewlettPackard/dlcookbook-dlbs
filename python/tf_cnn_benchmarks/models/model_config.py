...
_model_name_to_imagenet_model = {
    ...
    'alexnet_owt': alexnet_model.AlexnetOWTModel,
    'trivial': trivial_model.TrivialModel,
    'inception3': inception_model.Inceptionv3Model,
    'inception4': inception_model.Inceptionv4Model,
    'resnet18': resnet_model.create_dlbs_resnet18,
    'resnet34': resnet_model.create_dlbs_resnet34,
    'resnet50': resnet_model.create_dlbs_resnet50,
    'resnet101': resnet_model.create_dlbs_resnet101,
    'resnet152': resnet_model.create_dlbs_resnet152,
    'resnet200': resnet_model.create_dlbs_resnet200,
    'resnet269': resnet_model.create_dlbs_resnet269,
