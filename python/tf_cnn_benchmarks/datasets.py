...
def create_dataset(data_dir, data_name, depth=3, num_classes=None):
  ...
  if num_classes is None:
    num_classes = 1000 if data_name == 'imagenet' else 10

  return supported_datasets[data_name](data_dir, depth=depth, num_classes=num_classes)
...
class ImagenetData(Dataset):
  ...
  def __init__(self, data_dir=None, depth=3, num_classes=None):
...
class Cifar10Data(Dataset):
  ...
  def __init__(self, data_dir=None, depth=3, num_classes=None):
    super(Cifar10Data, self).__init__('cifar10', 32, 32, data_dir=data_dir,
                                      ...
                                      num_classes=num_classes, depth=3)
