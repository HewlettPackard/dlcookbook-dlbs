...
#ifndef DLBS_TENSORRT_BACKEND_CORE_FILESYSEM_POSIXFILESYSTEM
#define DLBS_TENSORRT_BACKEND_CORE_FILESYSEM_POSIXFILESYSTEM

#include "core/filesystem/file_system.hpp"

class posix_file_system : public file_system {
public:
    posix_file_system(const url &the_url) : file_system() {}
    virtual ~posix_file_system() {}
